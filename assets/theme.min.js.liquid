    ...
    on_cart_update: function(item){
      setTimeout(function(){
        jQuery.getJSON('/cart.js', function(cart) {
          ...
          $('#free_shipping_price').html('{{settings.free_shipping_text}}{{ free_shipping_amount | money_with_currency }}');
          }
...
jQuery(document).on('click', '.fly_addtocart', function(){
  ...
  var imgtodrag = jQuery(this).parents(".product-box").find(".front img.img-fluid").eq(0);
